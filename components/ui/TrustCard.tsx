  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-gold)]/12 border border-[var(--color-gold)]/18 text-[var(--color-gold)] group-hover:bg-[var(--color-gold)] group-hover:text-[var(--color-bg)] transition-colors duration-[var(--duration-normal)]" aria-hidden="true">
          {icon}
        </span>
